...
def _write_dataset(dataset: str, data_root: Path, model_dir: Path, output_csv: Path, include_valid_history: bool, chunk_size: int, mode: str) -> int:
...
def main():
    ...
    parser.add_argument("--model-dir", type=str, default="outputs/simple_heuristic_tuned")
    parser.add_argument("--output-dir", type=str, default="outputs/website_submission_simple_tuned")
